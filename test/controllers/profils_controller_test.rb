...
class ProfilsControllerTest < ActionController::TestCase
  ...
  test "should create profil" do
    assert_difference('Profil.count') do
      post :create, profil: { fachbereich: @profil.fachbereich, info: @profil.info, kurse: @profil.kurse, link: @profil.link, schulname: @profil.schulname, standort: @profil.standort, user_id: @profil.user_id }
    end
  ...
  test "should update profil" do
    patch :update, id: @profil, profil: { fachbereich: @profil.fachbereich, info: @profil.info, kurse: @profil.kurse, link: @profil.link, schulname: @profil.schulname, standort: @profil.standort, user_id: @profil.user_id }
    assert_redirected_to profil_path(assigns(:profil))
  end
